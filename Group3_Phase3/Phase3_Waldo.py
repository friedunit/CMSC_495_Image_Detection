...
# Fall 2020
# Authors/Contributors: John Kaiser, Orry Newell, Cody Ambrose, Rodney French
#
# Capstone - Phase III Code (Waldo - Multiple Characters)
#
# Our Capstone Phase III consisted of continued research of different computer vision algorithms and techniques to
# produce an image detection program that will find a target image in a larger "puzzle" image. Phase III included
# three simple Where's Waldo puzzle images and the five Where's Waldo characters as target images. Using simple
# puzzle images in this phase helped to build our understanding of which techniques work best without the noise of
# extremely complex Where's Waldo puzzles. Additionally, adding more characters allowed us to test our methods
# against more target images.
...
if __name__ == '__main__':
    # Target Images: Waldo, Wenda, Wizard, Odlaw, Woof
    target_dict = {'': '', 'Waldo': 'waldo_face.jpeg', 'Wenda': 'wenda.jpg', 'Wizard': 'wizard.jpg', 'Odlaw': 'odlaw.jpg',
                   'Woof': 'woofs_tail.jpg'}
    
    # Simple Puzzle Images: City, Zoo, Ski Resort
    puzzle_dict = {'': '', 'City': 'puzzle2.jpeg', 'Zoo': 'zoo.jpeg', 'Ski Resort': 'ski.jpeg'}
