...
#
# Capstone - Phase II Code (Waldo - Simple Puzzles)
#
# Our Capstone Phase II consisted of continued research of different computer vision algorithms and techniques to
# produce an image detection program that will find a target image in a larger "puzzle" image. Phase II included
...
# extremely complex Where's Waldo puzzles. 
...
if __name__ == '__main__':
    ...
    target_dict = {'': '', 'Waldo': 'waldo_face.jpeg'}
    
    # Simple Puzzle Images: City, Zoo, Ski Resort
    puzzle_dict = {'': '', 'City': 'puzzle2.jpeg', 'Zoo': 'zoo.jpeg'}
